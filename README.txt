Laravel 5.5 based Simple CRUD

Based on CRUD tutorial https://github.com/scotch-io/simple-laravel-crud
...
7. Copy (resources/views/nerds) folder into views folder of your project.
